...
{
    /// <inheritdoc />
    public partial class CreateFirstVersionOfDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Images/No_Image.png"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Doctors_Departments_DId",
                        column: x => x.DId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiseasePrecautions", x => new { x.PrecautionId, x.DiseaseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakAfterHours = table.Column<int>(type: "int", nullable: false),
